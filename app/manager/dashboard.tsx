...
export default function ManagerDashboard() {
  ...
  const recentActivities = [
    { title: 'Relatório Mensal Gerado', type: 'report', time: '2h atrás' },
    { title: 'Nova Turma Criada', type: 'class', time: '4h atrás' },
    { title: 'Backup Automático', type: 'backup', time: '6h atrás' },
    { title: 'Atualização de Sistema', type: 'update', time: '1 dia atrás' }
  ];
    ...
    <ScrollView style={[styles.container, { paddingHorizontal: '2%' }]} showsVerticalScrollIndicator={false}>
      ...
      <Card style={styles.card}>
        <Card.Title
          ...
          titleStyle={styles.cardTitle}
          left={(props) => <MaterialIcons {...props} name="schedule" size={24} color="#3b82f6" />}
        />
        <Card.Content style={styles.cardContent}>
            ...
            <View key={index}>
              <View style={styles.activityItem}>
                <View style={[styles.activityIcon, { backgroundColor: getActivityColor(activity.type) + '20' }]}>
                  <MaterialIcons name={getActivityIcon(activity.type) as any} size={16} color={getActivityColor(activity.type)} />
                </View>
